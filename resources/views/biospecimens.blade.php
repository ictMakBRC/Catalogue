                        ...
                        <div class="blog_posts">
                            <div class="container-md">
                                <div class="row">
                                    ...
                                    @foreach($biospecimens as $biovalue)
                                    <div class="col-xl-6">
                                        <div class="blog-card d-flex flex-sm-row flex-column">
                                            <div class="the_post_thumbnail">
                                                <a href="#"><img src="{{url('web/img/blog/bio.png')}}" alt="Blog Title" /></a>
                                            </div>
                                            <div class="blog-card-body">

                                                <h2 class="the_title">
                                                    <a href="#"> Specimen Type: {{ $biovalue->myspecimen}}</a>
                                                </h2>
                                                <h4>Qty: <span class="counter text-success">{{ $biovalue->biocount}}</span></h4>
                                                <br>
                                                <p>Available</p>

                                                <a href="{{url('biospecimens/specimenType/'.$biovalue->myspecimen)}}" class="the_permalink">View more <i class="icofont-arrow-right"></i></a>
