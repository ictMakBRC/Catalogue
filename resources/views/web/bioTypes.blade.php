        ...
        <section class="page--wrapper pt--80 pb--20">
            <div class="container">
                <ul class="subforums nav mt--10 text-darkest">
                    ...
                    <li><a href="topics.html">Biospecimens</a></li>
                                    ...
                                    <div class="col-md-12 col-xxs-12 col-xxs-12">
                                        <div class="box--items">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item">Available Biospecimen: {{ $value->biocount}}</li>
                                            ...
                                            <div class="card-footer">
                                                <ul class="subforums nav mt--10 text-darkest">
                                                    ...
                                                    <li><a href="{{url('biospecimens/all/'.$id.'/'.$value->project_acronym)}}" class="btn-link">View Biospecimens</a></li>
                                                </ul>
