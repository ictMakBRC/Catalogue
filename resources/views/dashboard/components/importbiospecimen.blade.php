<div class="modal fade" id="impTissues" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Upload Tissues CSV</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">	<span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ url('catalogue/tissues/import') }}" method="POST" name="importform"
                ...
                <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    <label  class="form-label">Upload Tissues CSV file</label>
