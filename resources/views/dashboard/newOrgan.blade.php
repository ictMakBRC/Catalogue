			...
			<!--page-content-->
				...
				<div class="page-content">
					...
					<div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
                        ...
                        <div class="ml-auto">
							<div class="btn-group">
								<button type="button" class="btn btn-primary">Organs</button>
								...
								<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left">
                                    ...
                                    <a href="{{url('catalogue/organs')}}" class="dropdown-item">Organs list</a>
                                                        ...
                                                        <div class="input-group">
                                                            <select class="single-select form-select" id="specimen_type_id" name="specimen_type_id" required>
                                                                ...
                                                                @foreach($specimentypes as $value)
                                                                    <option value="{{ $value->id }}">{{ $value->specimen_type}}</option>
                                                                @endforeach
                                                                @endif --}}
                                                            </select>
                                                        </div>
