...
@section('content')
			<!--page-content-->
				...
				<div class="page-content">
					...
					<!--end breadcrumb-->
					<div class="card">
						<div class="card-header">Add a new tissue</div>
						<div class="card-body">
							<br />
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" readonly name="project_acronym" id="ProjectAcronym" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="participant_id" id="participant_id" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="sample_id" id="sample_id" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="aliqout_type" id="aliqout_type" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="ethinicity" id="ethinicity" required>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="donor_status" id="donor_status" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="stored_for" id="stored_for" required>
                                                        </div>
                                                    </div>
