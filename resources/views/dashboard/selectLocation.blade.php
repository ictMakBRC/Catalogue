                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="mb-0">Please click on this <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleVerticallycenteredModal">Create location</a> link  to create your first store loction/branch!</p>
                            </div>
                        </div>
                    </div>
                </div>
